...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coordinatorLayout = (CoordinatorLayout) findViewById(R.id.app_container);
        emptyView = (TextView) findViewById(R.id.listview_forecast_empty);
    ...
    public void networkToast() {
        Snackbar.make(coordinatorLayout,  getResources().getString(R.string.string_network_toast_err), Snackbar.LENGTH_LONG).show();
